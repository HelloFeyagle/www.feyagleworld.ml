...
export default function Home({ better }) {
  ...
  return (
    <>
        ...
        <h1 className="font-medium text-4xl break-words max-w-2xl text-center">Merhaba,Biz
          <span className="text-cDiscord"> Felix Studioyuz</span>. 
        her zaman 
        ...
        <div className="hidden lg:block absolute w-full bottom-20">
          {user?.username && (
            <div className="w-full flex justify-center items-center space-x-4">
              ...
              <p className={`${slideAvatar ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-72'} transition-all duration-500 break-words max-w-xl text-xl font-medium`}>Merhaba, Burası Felix Studio. Javascript ile Kodlanan Bir Website.Yakında Resmi Uygulamalarımız Çıkacaktır. Okuduğunuz için teşekkürler :)</p>
            </div>
          )}
        </div>
      </div>
