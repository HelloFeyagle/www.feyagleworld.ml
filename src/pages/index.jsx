        ...
        <div className="hidden lg:block absolute w-full bottom-20">
          {user?.username && (
            <div className="w-full flex justify-center items-center space-x-4">
              ...
              <p className={`${slideAvatar ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-72'} transition-all duration-500 break-words max-w-xl text-xl font-medium`}>Merhaba, Ben Feyagle Yada Diğer Adım İle Featronn. Türkiye'de yaşıyorum ve discord botları yapıyorum. discord botları kullanırken javascript kullanırım. dost canlısıyım. Beraber konuşmak istiyorsan iletisim@feyagleworld.ml adresini kullanabilirsin. okuduğunuz için teşekkürler :)</p>
            </div>
          )}
        </div>
      </div>
