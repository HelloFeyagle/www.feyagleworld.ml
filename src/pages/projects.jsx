...
export default function Projects() {
    ...
    <div className="px-6 lg:px-36 h-full py-36 pt-24">
        ...
        <p style={{ zIndex: 2 }} className="relative ml-2 text-3xl lg:text-6xl font-medium">Projects</p>
          <p className="hidden lg:block absolute bottom-5 opacity-10 ml-2 text-8xl font-medium">Experience</p>
